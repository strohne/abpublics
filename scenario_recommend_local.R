...
# Agent-based publics.
#
# This script runs the scenario: selection (aka recommend_local)
#
...
world.definition <- tribble(
  ...
  "play",  "mediateMessages", list("recommend","local"),
...
runWorlds(world.definition,20,c(1:8),world.name = "logs/recommend_local")

plan(sequential)

# Gather generated logs. 
# Result is saved in directory "data".
gatherAndSaveHistory("logs/recommend_local","data/recommend_local")
